...
import nl.jhnbos.letsmeet.DateTimeInterpreter;
...
public class WeekView extends View {
        ...
        if (mWeekViewLoader != null) {
            ...
            if (!isInEditMode() && (mFetchedPeriod < 0 || mFetchedPeriod != periodToFetch || mRefreshEvents)) {
                ...
                if (currentPeriodEvents == null)
                    currentPeriodEvents = (List<WeekViewEvent>) mWeekViewLoader.onLoad(periodToFetch);
                if (previousPeriodEvents == null)
                    previousPeriodEvents = (List<WeekViewEvent>) mWeekViewLoader.onLoad(periodToFetch - 1);
                if (nextPeriodEvents == null)
                    nextPeriodEvents = (List<WeekViewEvent>) mWeekViewLoader.onLoad(periodToFetch + 1);
    ...
    public interface MonthChangeListener extends MonthLoader.MonthChangeListener {
        /**
